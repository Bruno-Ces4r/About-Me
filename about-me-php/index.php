    ...
    <section class="main-content">
        <div class="left-content">
            <div class="info-content">
                ...
                <p>This WebSite was created with the intencion of publicizing my portfolio, covering my history, resume and a way for people to get in touch with me.</p>
                <a href="./resume.php"><button type='button' class="btn btn-success button">Learn More</button></a>
