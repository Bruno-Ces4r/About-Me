...
<body class="corpo">
    ...
    <section class="main-contact">
        ...
        <section class="contact-description">
            ...
            <p class="box-contact"><img src="./image/linkedin.png" alt="" title="Linkedin" class="contact-page"> <a href="" class="my-contacts">Linkedin aqui</a> </p>
            <p class="box-contact"><img src="./image/email.png" alt="" title="E-mail" class="contact-page"> <a href="mailto:bruno.reis.profissional@gmail.com" class="my-contacts">bruno.reis.profissional@gmail.com</a></p>
            <p class="box-contact"><img src="./image/github.png" alt="" title="GitHub" class="contact-page"> <a href="" class="my-contacts">GitHub aqui</a> </p>
            <p class="box-contact"><img src="./image/instagram.png" alt="" title="Instagram" class="contact-page"> <a href="" class="my-contacts">Instagram aqui</a> </p>
        </section>
        ...
        <section class="controle-contact">
            ...
            <form action="" method="post">
                <div class="controle-form">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Tell me more about the oportunity:</label>
